  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <header class="bg-red-600 shadow-xl shadow-red-600/30 sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex items-center justify-between">
        ...
        <div class="text-white text-sm">
          <span class="bg-red-700 px-3 py-1 rounded-full">{{ filteredItems.length }} pratos</span>
        </div>
      </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <!-- Imagem do Prato -->
          <div class="relative h-48 bg-gradient-to-br from-red-100 to-red-50 flex items-center justify-center overflow-hidden">
      ...
      >
        <div
          ...
          @click.stop
        >
          <h2 class="text-2xl font-bold text-gray-900 mb-4">Editar Prato</h2>
